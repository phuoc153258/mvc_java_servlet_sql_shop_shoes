			...
			<div class="container">
				...
				<div class="row justify-content-center m-0">
					<div class="card w-100">
						<div class="card-body">
							<div class="container">
								<form action="/ShopShoes/users/password/handle" method="POST">
									<div class="form-group mb-3">
										<label for="">Old password:</label> <input type="password"
											class="form-control" placeholder="Old passwords..." name="oldpassword">
									</div>
									<div class="form-group mb-3">
										<label for="">New password:</label> <input type="password"
											class="form-control" placeholder="New password..." name="newpassword">
									</div>
									<div class="form-group mb-3">
									...
									<div class="d-flex flex-row-reverse" style="gap: 0 15px;">
										<button type="submit" class="btn btn-primary">Change
											password</button>
										<a href="/users/information" class="btn btn-secondary">Back</a>
									</div>
								</form>
							</div>
						</div>
