					...
					<div class="col-9">
						<div class="container">
							<div class="d-flex justify-content-between">
								...
								<a href="/ShopShoes/admin/products/create" class="d-flex align-items-center"> <span>Add
										product</span> <i class="fa-solid fa-plus"></i>
								</a>
							</div>
													...
													<c:forEach var="item" items="${products}" varStatus="loop">
														<tr>
															...
															<td><img alt="" class="w-50"
																src="/ShopShoes/${item.getImage() }"></td>
															<td class="d-flex" style="gap: 0 10px;"><a
																href="/ShopShoes/admin/products/detail?productId=${item.getId() }"><i
																	class="fa-solid fa-pencil"></i></a><a href="/ShopShoes/admin/products/delete?productId=${item.getId() }"><i
