						...
						<div class="container">
							...
							<div class="row justify-content-center m-0">
								<div class="card w-100">
									<div class="card-body">
										<div class="container">
											<form class="row" action="/ShopShoes/admin/products/update"
												method="post">
												<div class="col-4">
												...
												<div class="col-8">
													<div class="form-group mb-3">
														<label for="">Id:</label> <input type="text"
															...
															value="${product.getId() }" readonly name="id">
													</div>
													<div class="form-group mb-3">
													...
													<div class="form-group mb-3">
														<label for="">Origin:</label> <select class="form-control"
															id="exampleFormControlSelect1" name="origin">
															<c:forEach var="item" items="${origins}" varStatus="indx">
																<option value="${item.getId() }"
																	${item.getId()== product.getOriginId()? 'selected' : '' }>${item.getName() }</option>
															</c:forEach>
														</select>
													</div>
													<div class="form-group mb-3">
														<label for="">Design:</label><select class="form-control"
															...
															<c:forEach var="item" items="${designs}" varStatus="indx">
																<option value="${item.getId() }"
																	${item.getId()== product.getDesignId()? 'selected' : '' }>${item.getName() }</option>
															</c:forEach>
														</select>
													</div>
