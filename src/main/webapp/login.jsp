	...
	<div class="hero_area">
		...
		<div class="d-flex justify-content-center">
			...
			<div class="container"
				...
				<h2 class="m-5 text-center" style="font-weight: bold;">LOGIN</h2>
				<form action="/ShopShoes/login/handle" method="POST">
					...
					<div class="form-outline mb-4">
						<label class="form-label">Password:</label> <input type="password"
							name="txtPassword" style="text-transform: lowercase !important;"
							class="form-control" />
					</div>
					<div class="row mb-4">
